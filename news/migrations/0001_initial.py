# Generated by Django 6.0.3 on 2026-03-04 03:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='news.journalist')),
            ],
        ),
        migrations.AddField(
            model_name='customuser',
            name='subscriptions_journalists',
            field=models.ManyToManyField(blank=True, related_name='subscribed_readers', to='news.journalist'),
        ),
        migrations.CreateModel(
            name='Newsletter',
            fields=[
