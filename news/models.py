...
class CustomUser(AbstractUser):
    ...
    subscriptions_journalists = models.ManyToManyField(
        "Journalist", blank=True, related_name="subscribed_readers"
    )
...
class Journalist(models.Model):
    ...
    user = models.OneToOneField(
        "CustomUser", on_delete=models.CASCADE, limit_choices_to={"role": "journalist"}
    )
...
class Article(models.Model):
    ...
    author = models.ForeignKey(
        Journalist, on_delete=models.CASCADE, null=True, blank=True
    )
    publisher = models.ForeignKey(
