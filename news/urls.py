...
urlpatterns = [
    ...
    path(
        "article/<int:pk>/edit/",
        views.edit_article_content,
        name="edit_article_content",
    ),
    path("article/<int:pk>/approve/", views.approve_article, name="approve_article"),
    path(
        "comment/<int:article_id>/",
        views.post_article_comment,
        name="post_article_comment",
    ),
    path(
        "exclusive/<int:article_id>/",
        views.read_exclusive_report,
        name="read_exclusive_report",
    ),
    path("register/", views.register_user, name="register_user"),
    path(
        "password-reset/",
        views.send_news_password_reset,
        name="send_news_password_reset",
    ),
