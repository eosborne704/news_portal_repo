...
from .models import CustomUser, Article, Newsletter, ReaderComment, Publisher, Journalist
...
class RegisterUserForm(forms.ModelForm):
    ...
    class Meta:
        model = CustomUser
        fields = ["username", "password", "role", "subscriptions_publishers", "subscriptions_journalists"]
